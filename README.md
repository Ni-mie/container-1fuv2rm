...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-1fuv2rm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-1fuv2rm.containers.anotherwebservice.com/
...
```
git clone git@github.com:Ni-mie/container-1fuv2rm.git
cd container-1fuv2rm
```
...
```
docker attach container-1fuv2rm
```
